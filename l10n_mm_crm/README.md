# Myanmar CRM Localization (l10n_mm_crm)
...
Provides structured address management for sales pipeline with State/Region → District → Township → Town → Ward data.
...
1. Place `l10n_mm_crm` in your Odoo addons path
2. Update apps list: **Apps → Update Apps List**
3. Search for **"Myanmar CRM Localization"**
4. Click **Install**
